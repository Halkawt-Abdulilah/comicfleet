...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "6f2adf5985c8dc", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "479fde5adecdb2", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Comicfleet <no-reply@comicfleet.halkawtabdulilah.net>", "SMTP sender")
